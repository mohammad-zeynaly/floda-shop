...
const userLoginPasswordContainer = document.querySelector('#user-login-password');
...
function UserPasswordValidation () {
    ...
    userPasswordContainer.insertAdjacentHTML('beforeend' , '<small  class="color-red user-password-message d-none"> </small>')
    userPasswordWrapper.insertAdjacentHTML('beforeend' , '<small  class="color-red user-password-message__again d-none">   این فیلد الزامی می باشد  </small>')

    let userPasswordMessage = document.querySelector('.user-password-message')
    let userPasswordMessageAgin = document.querySelector('.user-password-message__again')
    ...
    if(userPasswordValue.length >= 1 && userPasswordValue.length <=  7) {
       ...
       userPasswordMessage.className = 'color-red user-password-message d-block'
            ...
            userPasswordMessage.className = 'color-red user-password-message d-block'
            userPasswordMessageAgin.className = 'color-red user-password-message__again d-block'
    ...
    setInterval( () => {
        ...
        userPasswordMessageAgin.className = 'color-red user-password-message__again d-none'
...
function loginUserNameAndPasswordValidation () {
    ...
    userLoginNameContainer.insertAdjacentHTML('beforeend' , '<small  class="color-red user-Name__Login  d-none"> این فیلد الزامی می باشد</small>')
    userLoginPasswordContainer.insertAdjacentHTML('beforeend' , '<small  class="color-red user-password__Login d-none">  این فیلد الزامی می باشد</small>')
    ...
    if(userLoginNameInput.value === '' || userLoginPasswordInput.value === ''){
        ...
        userPasswordLoinMessage.className = 'color-red user-password__Login d-block'
